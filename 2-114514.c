...
int main() {
    ...
    decimal_int = add_to_tail(decimal_int, 115);  // 表示 15

    printf("十进制整数部分: ");
    print_list(decimal_int);
    printf("\n");

    Node *base_n_int = decimal_to_base_n_int(decimal_int, 2);  // 转换为二进制
    printf("转换为二进制: ");
    ...
    decimal_frac = add_to_tail(decimal_frac, 125);  // 表示 0.14

    printf("十进制小数部分: 0.");
    print_list(decimal_frac);
    printf("\n");

    Node *base_n_frac = decimal_to_base_n_frac(decimal_frac, 2, 10);  // 转换为二进制
    printf("转换为二进制小数部分: 0.");
    print_list(base_n_frac);
    printf("\n");

    // 示例：二进制整数部分转换为十进制
    Node *back_to_decimal_int = base_n_to_decimal_int(base_n_int, 2);
    printf("二进制整数部分转回十进制: ");
    print_list(back_to_decimal_int);
    printf("\n");

    // 示例：二进制小数部分转换为十进制
    Node *back_to_decimal_frac = base_n_to_decimal_frac(base_n_frac, 2, 10);
